...
class HomeActivity : AppCompatActivity() { // Экран приложения

    private val TAG = "HomeActivity"

    override fun onCreate(savedInstanceState: Bundle?) { // Вызывается когда Activity создается в первый раз
        super.onCreate(savedInstanceState) // Обязательный вызов!
        setContentView(R.layout.activity_home) // Ссылается на мой шаблон
        Log.d(TAG, "onCreate")
